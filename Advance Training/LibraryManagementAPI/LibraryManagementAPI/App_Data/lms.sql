...
INSERT INTO `lms05` VALUES (1,'Admin','2022-01-01 00:00:00','2022-02-01 00:00:00'),(2,'Libtarian','2022-03-01 00:00:00','2022-03-01 00:00:00'),(3,'User','2022-03-07 00:00:00','2022-03-02 00:00:00');
...
CREATE TABLE `lms12` (
  ...
  `S12F04` int NOT NULL DEFAULT '3' COMMENT 'Role ID',
  ...
  KEY `StaffRoleID_idx` (`S12F04`),
  CONSTRAINT `StaffRoleID` FOREIGN KEY (`S12F04`) REFERENCES `lms05` (`S05F01`)
...
INSERT INTO `lms12` VALUES (1,'librarian1','1234',1,'2022-03-05 00:00:00','2022-03-05 00:00:00'),(2,'admin','1234',2,'2022-03-05 00:00:00','2022-03-05 00:00:00');
...
-- Dump completed on 2022-03-26  9:58:38
